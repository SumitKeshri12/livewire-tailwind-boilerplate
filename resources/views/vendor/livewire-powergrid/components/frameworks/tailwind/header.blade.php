<div>
    ...
    <div class="mb-2 md:mb-3 flex flex-row w-full justify-end items-center gap-1.5 md:gap-2">
        ...
        @if (count($this->filters()) > 0)
            ...
            >
                <button
                    ...
                    type="button"
                    title="Filter"
                    class="mobile-filter-toggle-btn flex rounded-md ring-1 transition focus:ring-2 dark:ring-gray-600 ring-gray-300 bg-blue-600 dark:bg-blue-600 border-0 py-1.5 focus:outline-none text-xs leading-5 w-11 h-9 inline-flex items-center justify-center focus:ring-blue-600 focus:ring-offset-1 cursor-pointer hover:bg-blue-700 dark:hover:bg-blue-700"
                >
                    <svg 
