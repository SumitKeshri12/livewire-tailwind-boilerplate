<div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
    ...
    <form wire:submit.prevent="store" class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700">
            ...
            <!-- Action Buttons -->
            <div class="flex flex-col md:flex-row gap-2 p-6 border-t border-neutral-200 dark:border-neutral-700">
                <flux:button type="submit" variant="primary" data-testid="submit_button" class="cursor-pointer"
                    wire:loading.attr="disabled" wire:target="store">
                    {{ __('messages.submit_button_text') }}
                </flux:button>
                <flux:button href="{{ route('email-template.index') }}" wire:navigate class="cursor-pointer">
