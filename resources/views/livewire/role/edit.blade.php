            ...
            <div class="p-0">
                <form wire:submit.prevent="store" class="flex flex-col space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="mt-3">
                            <flux:field>
                                <flux:label for="statusedit">{{ __('messages.role.create.label_status') }}</flux:label>

                                <flux:switch wire:model.live="statusedit" on-label="Yes" off-label="No" class="text-sm" />
                                <flux:error name="statusedit" />
                            </flux:field>
                        </div>
                    </div>
